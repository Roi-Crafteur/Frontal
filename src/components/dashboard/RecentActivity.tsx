...
export default function RecentActivity() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-6 shadow-lg h-full flex flex-col">
      ...
      <div className="space-y-2 sm:space-y-3 flex-1 overflow-y-auto">
        {activities.map((activity, index) => (
          ...
          >
            <div className={`p-1 sm:p-1.5 rounded-lg ${activity.color} flex-shrink-0`}>
